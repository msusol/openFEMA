...
To use these stylesheets, rename the files and openfema with the name of your theme.
...
openfema-alpha-default-narrow.css  
...
openfema-alpha-default-normal.css
...
openfema-alpha-default-wide.css
